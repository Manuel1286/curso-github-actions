...
import ui.dashboard.MovementsPage;
...
public class ValidateShortcutOptionsQuestion implements Question<Boolean> {
    ...
    public ValidateShortcutOptionsQuestion(String shortcutOption, String product, String productNumber) {
        ...
        try {
            switch (shortcutOption) {
                ...
                case LBL_DOCUMENTS:
                    ...
                    CommonQuestions.compareTextVsText(ShadowRoot
                            .getTextOfElementInsideOneShadowRoot(HOST_OPT_EXTRACTS,SHADOW_OPT_EXTRACTS),LBL_ACCORDION_ABSTRACT);
                    CommonQuestions.compareTextVsText(ShadowRoot
                            .getTextOfElementInsideOneShadowRoot(HOST_OPT_STATEMENTS,SHADOW_OPT_STATEMENTS), LBL_ACCORDION_CERTIFICATE);
                    CommonQuestions.compareTextVsText(ShadowRoot
                            .getTextOfElementInsideOneShadowRoot(HOST_OPT_REFERENCES, SHADOW_OPT_REFERENCES),LBL_ACCORDION_REFERENCE);
                    break;
                case LBL_MOVEMENTS:
    ...
    public static ValidateShortcutOptionsQuestion validateShortcutOptions(String shortcut, String product, String productNumber) {
