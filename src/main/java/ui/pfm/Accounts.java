...
public class Accounts {
    private Accounts() { }
    public static final String LBL_ALL_ACCOUNTS = "#card-list-0 > div.bdb-ml-card-list__main-content > "
        + "div > div > div.bdb-ml-card-list__main-content__header__detail__title";
    public static final String BUTTON_ACCOUNTS = "#card-list-0";
    public static final String SD_TAB_ACCOUNTS = "body > app-root > ion-app > ion-router-outlet > "
    ...
    public static final String SD_DROP_DOWN_ALL_ACCOUNTS = "body > app-root > ion-app > ion-router-outlet > "
    ...
    public static final Target BUTTON_SEARCH = Target.
        the("Btn Buscar").
        locatedBy("#pfm_selector_search_button");
    public static final Target VALUE = Target.
        the("Saldo").
        locatedBy("#chart-area > svg > g > text:nth-child(6) > tspan");
    public static final String SD_BUTTON_LIST = "body > app-root > ion-app > ion-router-outlet >"
        + " bdb-pfm > ion-content > div > div > "
        + "div.page-pfm__content__box-account_and_date_selector.ng-star-inserted > bdb-ml-card-list";
    public static final String CA = "#ion-overlay-4 > div.modal-wrapper.ion-overlay-wrapper.sc-ion-modal-md > "
