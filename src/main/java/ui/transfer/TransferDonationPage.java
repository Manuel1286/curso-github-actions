...
public class TransferDonationPage {
  ...
  public static final Target TXT_DONATION_VALUE =
      Target.the("Caja para ingresar el valor para la donación")
          .locatedBy("#transfers-accounts__form-transfer-value");
  public static final Target BTN_DONATION =
      Target.the("botón de Realizar donación").locatedBy("#transfer_accounts_btn");
  public static final Target LBL_NAME_TELETON =
      Target.the("Texto Superior de nombre del convenio")
