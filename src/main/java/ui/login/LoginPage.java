...
public class LoginPage {
  ...
  public static final Target OTHER_USER =
      Target.the("Ingresar con otro usuario")
          .locatedBy(
              "//button[contains(@class, 'bdb-change-user-btn') and text()='Ingresar con otro usuario']");
  public static final String HOST_OTHER_USER =
      "#ion-overlay-1 > bdb-action-sheet-wc > bdb-ml-bm-action-sheet";
  public static final String H_OTHER_USER = "#label__1";

  public static final Target DESVINCULAR =
      Target.the("Desvincular").locatedBy(".bdb-replace-user__submit-btn.bdb-btn.bdb-btn--primary");
  public static final Target CHECK_TC =
      Target.the("Check_TYC").locatedBy(".bdb-checkbox__checkmark");
}
