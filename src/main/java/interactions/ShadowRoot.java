...
public class ShadowRoot {
    ...
    public static void clickOnElementInsideThreeShadowRoots(
        String firstShadowHost, String firstNestedShadowedInput,
        String secondNestedShadowedInput, String thirdNestedShadowedInput) {
        thirdJsExecutorMethod(
            firstShadowHost, firstNestedShadowedInput, secondNestedShadowedInput, thirdNestedShadowedInput).click();
    }

    public static void clickOnElementInsideFourShadowRoots(
        String firstShadowHost, String firstNestedShadowedInput,
        String secondNestedShadowedInput, String thirdNestedShadowedInput, String fourthNestedShadowedInput) {
        fourthJsExecutorMethod(firstShadowHost, firstNestedShadowedInput,
            secondNestedShadowedInput, thirdNestedShadowedInput, fourthNestedShadowedInput).click();
    }

    public static void clickOnElementInsideFiveShadowRoots(
        String firstShadowHost, String secondShadowHost, String thirdShadowHost, String fourthShadowHost,
        String fifthShadowHost, String nestedShadowedInput) {
        fifthJsExecutorMethod(firstShadowHost, secondShadowHost,
            thirdShadowHost, fourthShadowHost, fifthShadowHost, nestedShadowedInput).click();
    }
    ...
    public static String getTextOnElementInsideThreeShadowRoots(
        ...
        return thirdJsExecutorMethod(
            firstShadowHost, firstNestedShadowedInput, secondNestedShadowedInput, thirdNestedShadowedInput).getText();
    }
    ...
    public static void sendKeysToElementInsideTwoShadowRoot(
        String firstShadowHost, String firstNestedShadowedInput, String secondNestedShadowedInput, String key) {
    ...
    public static void clickAndScrollOnElementInsideTwoShadowRoots(
        String firstShadowHost, String firstNestedShadowedInput, String secondNestedShadowedInput) {
        WebElement elementToClick = secondJsExecutorMethod(firstShadowHost,
            firstNestedShadowedInput, secondNestedShadowedInput);
        ((JavascriptExecutor) getDriver()).executeScript("arguments[0].scrollIntoView();", elementToClick);
        try {
            Thread.sleep(5000);
    ...
    private static WebElement firstJsExecutorMethod(String firstShadowHost, String firstNestedShadowedInput) {
        ...
        return (WebElement) JS_EXECUTOR.executeScript(
            QUERY + "('" + firstNestedShadowedInput + "');", findShadowHost);
    }
    ...
    private static WebElement thirdJsExecutorMethod(
        String firstShadowHost, String firstNestedShadowedInput,
        String secondNestedShadowedInput, String thirdNestedShadowedInput) {
        WebElement secondNestedElement = secondJsExecutorMethod(
    ...
    private static WebElement fourthJsExecutorMethod(
        String firstShadowHost, String firstNestedShadowedInput, String secondNestedShadowedInput,
        String thirdNestedShadowedInput, String fourthNestedShadowedInput) {
        WebElement thirdNestedElement = thirdJsExecutorMethod(
            firstShadowHost, firstNestedShadowedInput, secondNestedShadowedInput, thirdNestedShadowedInput);
        return (WebElement) JS_EXECUTOR.executeScript(
            QUERY + "('" + fourthNestedShadowedInput + "');", thirdNestedElement);
    }

    private static WebElement fifthJsExecutorMethod(
        String firstShadowHost, String secondShadowHost,
        String thirdShadowHost, String fourthShadowHost, String fifthShadowHost, String nestedShadowedInput) {
        WebElement fourthNestedElement = fourthJsExecutorMethod(
            firstShadowHost, secondShadowHost, thirdShadowHost, fourthShadowHost, nestedShadowedInput);
        return (WebElement) JS_EXECUTOR.executeScript(
            QUERY + "('" + fifthShadowHost + "');", fourthNestedElement);
    }
