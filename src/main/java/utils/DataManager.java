...
public class DataManager {
    ...
    enum Users {
        ...
        CRISTIAN("Cristian", "usuario con cedula de extranjeria") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.CEDULA_EXTRANJERIA, "203174", "1234", "35978297", "", "");
            }
        },
        ...
        GERMAN("German", "usuario con tarjeta de identidad, ingreso con TD") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.TARJETA_IDENTIDAD, "1097503474", "1234", "", "", "4971");
            }
        },
        ...
        JULIETH("Julieth", "usuario ctas de ahorro y TC visa gold") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.CEDULA_EXTRANJERIA, "2006354", "1234",
        ...
        ALONSO("Alonso", "usuario con AH CCT Creditos y servicios ") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.CEDULA_EXTRANJERIA, "2001742", "1234", ConstantsForgetPasword.DEBIT_CARD, "1234", "");
            }
        },
        ...
        ESTRELLA(
            ...
            public UserLoginData loginData() {
                return new UserLoginData(
                    DocumentType.CEDULA, "63343977", "1234", ConstantsForgetPasword.CREDIT_CARD, "1234", "");
            }
        },
        ...
        PABLO("Pablo", "Usuario con TD por bloquear") {
            ...
            public UserLoginData loginData() {
                return new UserLoginData(
                    DocumentType.CEDULA, "19902734", "1234", "", "1234", "");
            }
        },
        ENRIQUE("Enrique","Usuario para enviar dinero por TY"){
          ...
          public UserLoginData loginData(){
              return new UserLoginData(
                  DocumentType.CEDULA, "14207840","1234","","1234","");
          }
        },
        ...
        TOBIAS("Tobias", "usuario con producto principal TC para olvido de clave") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.CEDULA, "2006730", "1234", ConstantsForgetPasword.CREDIT_CARD, "05378222", "4484");
            }
        },
        MATIAS("Matias", "usuario con producto principal TD para ingreso con TD") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.CEDULA, "2006741", "1234", ConstantsForgetPasword.CREDIT_CARD, "4915110205383527", "3527");
            }
        },
        GERMAIN("Germain", "usuario con producto principal crédito para olvido de clave") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.PASAPORTE, "302618", "1234", ConstantsForgetPasword.CREDIT_ACCOUNT, "57147151", "");
            }
        },
        GIGLIANA("Gigliana", "usuario con producto principal CDT para olvido de clave") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.CEDULA, "19107164", "1234", ConstantsForgetPasword.CDT_ACCOUNT, "0213443229", "");
            }
        },
        ...
        INGRID("Ingrid", "Usuario monoproduto crédito de vivienda") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.PASAPORTE, "302619", "1234", ConstantsForgetPasword.CREDIT_ACCOUNT, "00357147160", "");
            }
        },
        ...
        MAICON("Maincon", "Usuario sin clave segura") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.PASAPORTE, "303219", "1234", ConstantsForgetPasword.SAVING_ACCOUNT, "000343558", "");
            }
        },
        ...
        ELSY("Elsy", "Usuario sin clave segura") {
            @Override
            public UserLoginData loginData() {
                return new UserLoginData(DocumentType.CEDULA, "80793597", "1234", ConstantsForgetPasword.CREDIT_CARD, "62829754", "");
            }
        },
        ...
        MARIANA("Mariana", "Usuario con cuenta de ahorros, TC Clasica, Adelanto de nomina y Credito de vivienda") {
            @Override
            public UserLoginData loginData() {
        ...
        DAMIAN("Damian", "usuario no Existe") {
            ...
            public UserLoginData loginData() {
                return new UserLoginData(
                    DocumentType.CEDULA, "73101367", "1234", "", "", "");
            }
        },;
