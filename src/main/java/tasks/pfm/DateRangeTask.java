...
public class DateRangeTask implements Task {
    ...
    public <T extends Actor> void performAs(T actor) {
        ShadowRoot.clickAndScrollOnElementInsideTwoShadowRoots(
            Calendar.SD_OPEN_CALENDAR, Calendar.BUTTON_HOST_CALENDAR, Calendar.ONE_JANUARY_DATE_CALENDAR);
        ShadowRoot.clickAndScrollOnElementInsideTwoShadowRoots(
            Calendar.SD_OPEN_CALENDAR, Calendar.BUTTON_HOST_CALENDAR, Calendar.TWO_JANUARY_DATE_CALENDAR);
